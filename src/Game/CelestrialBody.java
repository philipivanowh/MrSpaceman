...
public class CelestrialBody {
    ...
    public CelestrialBody(double x, double y, int radius, double mass, boolean sun, Color color,
    ...
    public void update(ArrayList<CelestrialBody> other) {
        ...
        // orbit cord update
int px = (int)((pos.x-radius/2) * PHYSICS_CONSTANT.AU_TO_PIXELS_SCALE);
int py = (int)((pos.y-radius/2) * PHYSICS_CONSTANT.AU_TO_PIXELS_SCALE);
orbits.add(new Vector2D(px, py));
    ...
    public void render(Graphics2D g2) {
        ...
        g2.fillOval(centerX, centerY, (int) radius, radius);


        if(orbits.size() > 3){
        //drawOrbit
            drawOrbit(g2, orbits, 2f);
        }
